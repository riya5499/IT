<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="extra_3.WebForm1" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Label" runat="server">
    <asp:Label ID="Label1" runat="server" Text="Internal Style"></asp:Label>
</asp:Content>
